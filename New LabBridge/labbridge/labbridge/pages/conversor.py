    ...
    return rx.box(
        rx.vstack(
            ...
            rx.box(
                rx.vstack(
                    rx.hstack(
                        rx.text("Etapas do Processo", font_weight="600", color=Color.TEXT_PRIMARY),
                        rx.spacer(),
                        rx.text("Conversão guiada", font_size="0.875rem", color=Color.TEXT_SECONDARY),
                        width="100%",
                        align="center",
                    ),
                    rx.hstack(
            ...
            rx.box(
                rx.vstack(
                    rx.hstack(
                        rx.text("Recursos do Conversor", font_weight="600", color=Color.TEXT_PRIMARY),
                        rx.spacer(),
                        rx.text("Processamento local seguro", font_size="0.875rem", color=Color.TEXT_SECONDARY),
                        width="100%",
                        align="center",
                    ),
                    rx.grid(
