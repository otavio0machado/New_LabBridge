...
def metric_card_premium(title: str, value: str, icon: str, subtitle: str = "", color_scheme: str = "green", delay: str = "0s"):
    ...
    colors = {
        ...
        "orange": (Color.WARNING, Color.WARNING_BG, "triangle-alert"),
        "red": (Color.ERROR, Color.ERROR_BG, "circle-x"),
    }
            ...
            rx.box(
                rx.grid(
                    rx.vstack(
                        ...
                        rx.text(f"{State.patient_history_data.length()}", size="6", weight="bold", color=Color.DEEP),
